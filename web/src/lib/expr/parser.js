...
exports.Parser = exports.Program = exports.ExpressionStatement = exports.LetStatement = exports.InflixExpression = exports.PrefixExpression = exports.IntegerLiteral = exports.Identifier = void 0;
...
var Parser = /** @class */ (function () {
    function Parser(input) {
        ...
        this.inflixParseFns.set(token_1.LESS_THAN_EQUAL, this.__parseInflixExpression);
        this.inflixParseFns.set(token_1.GREATER_THAN, this.__parseInflixExpression);
        this.inflixParseFns.set(token_1.GREATER_THAN_EQUAL, this.__parseInflixExpression);
    }
    ...
    Parser.prototype.__parseExpression = function (precedence) {
        ...
        while (!this.__peekTokenIs(token_1.SEMICOLON) &&
    ...
    Parser.prototype.parse = function () {
        ...
        while (((_a = this.curToken) === null || _a === void 0 ? void 0 : _a.type) !== token_1.EOF) {
