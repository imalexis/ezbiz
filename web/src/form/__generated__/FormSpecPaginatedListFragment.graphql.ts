...
export type FormSpecPaginatedListFragment$data = {
  ...
  readonly " $fragmentType": "FormSpecPaginatedListFragment";
};
export type FormSpecPaginatedListFragment$key = {
  readonly " $data"?: FormSpecPaginatedListFragment$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./FormSpecPaginatedListQuery.graphql')
    }
  },
