...
export type FormInstanceResponseContainerQuery$variables = {
  after?: any | null | undefined;
  first: number;
  where?: FormInstanceWhereInput | null | undefined;
};
export type FormInstanceResponseContainerQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"FormInstanceResponsePaginatedTable_formSpec">;
};
export type FormInstanceResponseContainerQuery = {
  response: FormInstanceResponseContainerQuery$data;
  variables: FormInstanceResponseContainerQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "FormInstanceResponseContainerQuery",
    "selections": [
      {
        "args": null,
        "kind": "FragmentSpread",
